...
public class ZooInfoThreadPool {
...
//			service = Executors.newSingleThreadExecutor();
			...
			service.execute(() -> {
				...
				System.out.println("Printing zoo inventory A");
			});
			...
			service.execute(() -> {
				...
				System.out.println("Printing zoo inventory B");
			});
			...
			service.execute(() -> {
				...
				System.out.println("Printing zoo inventory C");
			});
